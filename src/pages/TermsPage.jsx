        ...
        <div className="page-container">
            <div className="page-content">
                <div className="page-inner">
                    <SEO
                        title="Terms of Service | Naam Jaap Counter"
                        description="Read the terms of service for using Japa Counter, a spiritual tool for mantra chanting."
                    />
                    <h1 className="guru-main-title">Terms of Service</h1>

                    <div
                        className="guru-card static-page-card animate-slide-up"
                    >
                        <p className="static-page-text small-mute">Last Updated: March 2026</p>

                        <section className="static-page-subsection">
                            <h3 className="static-page-subtitle-h3">1. Spiritual Nature of the App</h3>
                        ...
                        <section className="static-page-subsection">
                            <h3 className="static-page-subtitle-h3">2. User Conduct</h3>
                            <p className="static-page-text">
                        ...
                        <section className="static-page-subsection">
                            <h3 className="static-page-subtitle-h3">3. Data Integrity</h3>
                            <p className="static-page-text">
                        ...
                        <section className="static-page-subsection">
                            <h3 className="static-page-subtitle-h3">4. Modifications</h3>
                            <p className="static-page-text">
                        ...
                        <p className="static-page-text terms-footer-note">
